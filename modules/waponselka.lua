...
local Weapons = {
    ...
    [`weapon_m6ic`] = { object = `w_ar_carbineriflemk2`, item = 'WEAPON_M6IC', rot = vector3(10,150,0)},


    [`weapon_combatpdw`] = { object = `w_sb_pdw`, item = 'WEAPON_COMBATPDW', rot = vector3(180,160,0)},

    [`weapon_pumpshotgun`] = {object = `w_sg_pumpshotgun`, item = 'WEAPON_PUMPSHOTGUN', rot = vector3(0,160,0)},
    ...
    [`WEAPON_SNIPERRIFLE`] = {object = `w_sr_sniperrifle`, item = 'WEAPON_SNIPERRIFLE', rot = vector3(0,170,0)},

    [`WEAPON_SMG_MK2`] = {object = `w_sb_smgmk2`, item = 'WEAPON_SMG_MK2', rot = vector3(0,0,0)},

    [`WEAPON_SMG`] = {object = `w_sb_smg`, item = 'WEAPON_SMG', rot = vector3(180,165,0)},
    ...
    [`WEAPON_MARKSMANRIFLE`] = {object = `w_sr_marksmanrifle`, item = 'WEAPON_MARKSMANRIFLE', rot = vector3(0,176,0)},

    [`WEAPON_HEAVYSNIPER`] = {object = `w_sr_heavysniper`, item = 'WEAPON_HEAVYSNIPER', rot = vector3(0,180,0)},
...
local slots = {
    [1] = {
        pos = vec3(0.24, -0.18, -0.05), -- Center Of Back
        entity = nil,
        hash = nil,
        wep = nil
    },
